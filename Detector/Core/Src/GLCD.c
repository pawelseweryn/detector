...
void LCD_Initializtion( void )
{
  ...
  if( (DeviceCode == 0x9325) || (DeviceCode == 0x9328) )
  {
    ...
    LCD_Code = SSD1289;
    LCD_WriteReg( 0x0000, 0x0001 );    HAL_Delay( 50 );   /* �򿪾��� */
    LCD_WriteReg( 0x0003, 0xA8A4 );    HAL_Delay( 50 );
    ...
    LCD_WriteReg( 0x0001, 0x2B3F );    HAL_Delay( 50 );   /* �����������320*240 0x2B3F */
    LCD_WriteReg( 0x0002, 0x0600 );    HAL_Delay( 50 );
    LCD_WriteReg( 0x0010, 0x0000 );    HAL_Delay( 50 );
    LCD_WriteReg( 0x0011, 0x6070 );    HAL_Delay( 50 );   /* �������ݸ�ʽ 16λɫ ���� 0x6070 */
    ...
    LCD_WriteReg( 0x0007, 0x0133 );    HAL_Delay( 50 );
    LCD_WriteReg( 0x000B, 0x0000 );    HAL_Delay( 50 );
    LCD_WriteReg( 0x000F, 0x0000 );    HAL_Delay( 50 );   /* ɨ�迪ʼ��ַ */
...
void LCD_Clear( uint16_t Color )
{
  ...
  if( (LCD_Code == HX8347D) || (LCD_Code == HX8347A) || (LCD_Code == HX8346A) )
  {
    LCD_WriteReg( 0x02, 0x00 );
    LCD_WriteReg( 0x03, 0x00 );
...
{
  HAL_GPIO_WritePin( BL_CNT_GPIO_Port, BL_CNT_Pin, state );
}
